...
@Index('enterprise_profile_enterprise_id_profile_id_relation_type_key', ['enterpriseId', 'profileId', 'relationType'], {
    unique: true,
})
...
export class EnterpriseProfile {
    ...
    @ManyToOne(() => Enterprises, (enterprises) => enterprises.enterpriseProfiles, { onDelete: 'CASCADE' })
