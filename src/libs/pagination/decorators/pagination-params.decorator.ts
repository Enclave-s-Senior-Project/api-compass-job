...
export const PaginationParams = createParamDecorator(
    (
        ...
        const {
            query: { skip: querySkip, page: queryPage, limit: queryLimit, orderBy, orderDirection, ...params },
        ...
        const limit = queryLimit && +queryLimit > 0 ? Math.min(+queryLimit, maxAllowedSize) : defaultLimit;
